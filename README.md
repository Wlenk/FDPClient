...
JCef is a HTML renderer and can be works with LWJGL. If you want to learn more about it, check out its [bitbucket](https://bitbucket.org/chromiumembedded/java-cef)
